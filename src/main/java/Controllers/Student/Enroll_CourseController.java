 ...
 * @author
 */
public class Enroll_CourseController implements Initializable {
    ...
    private void enrollCourseButtonAction(MouseEvent event) {
        ...
        if (courseName.equals("")
            ...
            String update3 = "INSERT INTO timetable(id, courseName,courseID,tutorName)" + "VALUES(?,?,?,?)";
            ...
            try {
                ...
                pst3.setString(1, reg_txt_id.getText());
                pst3.setString(2, add_coursename.getText());
                pst3.setString(3, add_courseid.getText());
                pst3.setString(4, add_tutorname.getText());
                pst3.executeUpdate();

                JOptionPane.showMessageDialog(null, "Successfully Enrolled into the Course!!");
                autoRefresh();
            } catch (SQLException ex) {
                Logger.getLogger(Enroll_CourseController.class.getName()).log(Level.SEVERE, null, ex);
