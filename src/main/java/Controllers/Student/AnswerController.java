...
public class AnswerController implements Initializable {
    ...
    @FXML
    private void addAssessmentButtonAction(MouseEvent event) {
        ...
        String givenMarks = add_givenmarks.getText();
        String question = add_question.getText();
        String answer = add_answer.getText();
        ...
        if (courseName.equals("")
            ...
            String update = "INSERT INTO added_answer(id, courseName,courseID,tutorName,givenMarks,question, studentName, regNo, answer)" + "VALUES(?,?,?,?,?,?,?,?,?)";
            connection = DBHandler.connectDB();
            try {
            ...
            try {
                ...
                pst.setString(5, add_givenmarks.getText());
                pst.setString(6, add_question.getText());
                pst.setString(7, add_studentName.getText());
                pst.setString(8, add_reg.getText());
                pst.setString(9, add_answer.getText());

                pst.executeUpdate();

                JOptionPane.showMessageDialog(null, "Successfully Answered the Question!!");
                autoRefresh();
            } catch (SQLException ex) {
