 ...
 * @author
 */
public class Update_AssessmentController implements Initializable {
    ...
    private void addAssessmentButtonAction(MouseEvent event) {
        ...
        if (courseName.equals("")
            ...
            String update = "UPDATE add_assessment set id = ?, courseName = ?,courseID = ?,tutorName = ?,givenMarks = ?,question = ? where id = '" + id + "' ";
            connection = DBHandler.connectDB();
            try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Successfully Updated Assessment!!");
                autoRefresh();
            } catch (SQLException ex) {
