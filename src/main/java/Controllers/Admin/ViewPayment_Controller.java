 ...
 * @author
 */
public class ViewPayment_Controller implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		final JOptionPane optionPane = new JOptionPane("Please Wait...Hosted SQL Server is Slow",
			...
			public void run() {
				try {
					...
					try {
						...
						while (rs.next()) {
							// get string from db
							data.add(new PaymentDetails(rs.getString(1), rs.getString(2), rs.getString(3),
	...
	private void autoRefresh() {
		...
		try {
			...
			while (rs.next()) {
				// get string from db
				data.add(new PaymentDetails(rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
